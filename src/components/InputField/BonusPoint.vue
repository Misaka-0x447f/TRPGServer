    ...
    <div class="container">
      ...
      <div>
        <div v-for="v in InheritedDef.initialPoint" class="panel-container">
          ...
          <bu @click="operate(v, true)" :enabled="allocateEnabled" inline>
            <font-awesome-icon :icon="ico.caretUp"></font-awesome-icon>
          </bu>
          <bu @click="operate(v, false)" :enabled="freeEnabled(v)" inline>
...
<script lang="ts">
  ...
  export default Vue.extend({
    ...
    methods: {
      ...
      operate(which: InitialPointDef, isIncrease: boolean) {
